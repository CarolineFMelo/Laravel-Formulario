            ...
            <div class="modal-content">
                <form id="formProduto" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="quantidadeProduto" class="control-label">Quantidade no estoque</label>
                            <div class="input-group">
                                <input type="number" class="form-control" id="quantidadeProduto" placeholder="Quantidade no estoque">
                            </div>
                        </div>
                        <div class="form-group">
